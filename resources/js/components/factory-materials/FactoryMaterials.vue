            ...
            <div v-if="ads.length > 0" class="containp  container">
                                ...
                                <div class="card-body"
                                    ...
                                    <div style="padding-left: 1rem; padding-right: 1rem ; ">
                                        <div class="row">
                                            ...
                                            <div class="col-md-1 row-col-with view" style="margin-top: 43px;padding-right: 0;padding-left: 0;">
                ...
                <div class="col-lg-12 col-md-12 mt-5 mb-5">
                    <div class="pagination-area">
                        <a href="/factory-materials?page=1" class="prev page-numbers">
                            <i class="fas fa-angle-double-left"></i>
                        </a>
                        <a v-for="i in last_page" :key="i" :href="'/factory-materials?page=' + i"
                            v-bind:class="[currentPage == i ? 'page-numbers current' : 'page-numbers']">{{ i }}</a>
                        <a :href="'/factory-materials?page=' + last_page" class="next page-numbers">
