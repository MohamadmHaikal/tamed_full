            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="blog-post-content">
                            <h3>
                                <router-link to="/blog-details">Tips to Protecting Business and Family</router-link>
                            </h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="blog-post-content">
                            <h3>
                                <router-link to="/blog-details">Protect Your Workplace from Cyber Attacks</router-link>
                            </h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="blog-post-content">
                            <h3>
                                <router-link to="/blog-details">Business Debit Fees to Increase in 2019</router-link>
                            </h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="blog-post-content">
                            <h3>
                                <router-link to="/blog-details">10 Tips To Reduce Your Card Processing Costs
                                </router-link>
                            </h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="blog-post-content">
                            <h3>
                                <router-link to="/blog-details">PayPal Here Card Reader Review 2019</router-link>
                            </h3>
