            ...
            <div v-if="ads.length > 0" class="containp  container">
                                    ...
                                    <div style="padding-left: 1rem; padding-right: 1rem ; ">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-6  mt-3">
                                                ...
                                                <span style="color:#019aa2;  font-size: 20px; padding-right: 2px;">    {{ad.quotes_count}} 
                                                 {{' '}}</span>
                ...
                <div class="col-lg-12 col-md-12 mt-5 mb-5">
                    <div class="pagination-area">
                        <a href="/DealsAuctions?page=1" class="prev page-numbers">
                            <i class="fas fa-angle-double-left"></i>
                        </a>
                        <a v-for="i in last_page" :key="i" :href="'/DealsAuctions?page=' + i"
                            v-bind:class="[currentPage == i ? 'page-numbers current' : 'page-numbers']">{{ i }}</a>
                        <a :href="'/DealsAuctions?page=' + last_page" class="next page-numbers">
