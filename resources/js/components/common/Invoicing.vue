            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="invoicing-content">
                        ...
                        <div class="bar"></div>
                        <p>نظام متكامل يتيح للمنشآة إنشاء العقود الالكترونية والفواتير الالكترونية منمنشآة الى منشآة او من منشأة الى فرد مطابق لشروط هيئة الزكاه والدخل</p>
                        <router-link :to="{ name: 'blog', params: { type: 'contracts' } }" class="btn reg btn-warning btn-animation">
                           التفاصيل
                        </router-link>
                    </div>
                </div>
