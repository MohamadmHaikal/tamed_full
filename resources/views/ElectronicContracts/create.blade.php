                            ...
                            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                ...
                                <div class="widget-content widget-content-area br-6 ">
                                    ...
                                    <form action="{{ route('ElectronicContracts.store') }}" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group"><label
                                                    ...
                                                    <select class="form-control" name="adjective"
                                                        ...
                                                        <option value="Owners">{{ __('backend.Owners') }}</option>
                                                        <option value="executor">{{ __('backend.executor') }}</option>
                                                        <option value="joint">{{ __('backend.joint') }}</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="ads_id" value="{{ request()->ads_id }}"
                                                            hidden>
                                                            <input type="text" name="quotes_id" value="{{ request()->quotes_id }}"
                                                            hidden>
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn btn-soft-primary check "
                                                                style="border-radius: 23px 0px 0px 23px;"
                                        ...
                                        <hr class="rounded" style=" border-top: 2.5px solid #e5eaff; margin-left: 15%;">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label
                                                    ...
                                                    <textarea type="text" name="Brief_description" class="form-control " row="2"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label
                                                    ...
                                                    <textarea type="text" name="description" class="form-control " row="3"
                                                        aria-describedby="inputGroupPrepend" required></textarea>
                                                    <div class="invalid-feedback">
