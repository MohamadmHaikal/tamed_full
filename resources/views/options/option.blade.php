...
<div id="hh-options-wrapper" class="hh-options-wrapper">
    ...
    <div class="hh-options-tab" data-tabs-calculation>
        <div class="nav nav-pills nav-pills-tab" id="v-pills-tab" role="tablist" data-tabs aria-orientation="vertical">
            <?php
            // dd($options['sections'] );
            ...
            ?>
            <a class="nav-link nav-settings mb-2 {{ $class }}" data-tabs-item
                id="v-pills-{{ $section['id'] }}-tab" data-toggle="pill" href="#v-pills-{{ $section['id'] }}"
                role="tab" aria-controls="v-pills-{{ $section['id'] }}" aria-selected="true">
    ...
    <div class="hh-options-tab-content">
        <div class="tab-content">
            @foreach ($options['sections'] as $key => $section)
                ...
                <div class="tab-pane fade {{ $class }}" id="v-pills-{{ $section['id'] }}" role="tabpanel"
                    aria-labelledby="v-pills-{{ $section['id'] }}-tab">
                    <form class="form hh-options-form form-translation" action="{{ dashboard_url('settings') }}"
