                    ...
                    <div class="login-bg">
                        <div class="center-two-start">
                            <h6 class="right-bar-heading px-3 mt-2 text-dark text-center font-30 text-uppercase">
                                {{ __('Forget Password ?') }}</h6>
                            <div class="form-1">
                                <p class="text-center text-muted mt-3 mb-3 font-14">{{ __('Enter you email address below') }}
                                </p>
                            ...
                            <div class="form-2">
                                ...
                                <form method="get" class="digit-group mt-5" data-group-name="digits" data-autosubmit="false"
                                    autocomplete="off">
