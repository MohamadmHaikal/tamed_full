                ...
                <div class="col-xl-5 col-lg-6 col-md-6">
                    <div class="d-flex flex-column justify-content-between  right-area ">
                        ...
                        <div class="d-flex align-items-center justify-content-center title">
                            <h3 class="title-welcome">التسجيل في منصة تعميد أفراد</h3>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-2">
                                ...
                                <form method="get" class="digit-group mt-3 " data-group-name="digits"
                                    ...
                                    <input type="text" id="digit-1" nputmode="numeric" name="digit-1" data-previous="digit-2" />
                                    <input type="text" id="digit-2" nputmode="numeric" name="digit-2" data-next="digit-1"
                                        data-previous="digit-3" />
                                    <input type="text" id="digit-3" nputmode="numeric" name="digit-3" data-next="digit-2"
                                        data-previous="digit-4" />
                                    <input type="text" id="digit-4" nputmode="numeric" name="digit-4" data-next="digit-3" />
                                </form>
