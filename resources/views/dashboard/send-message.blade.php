                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="javascript:void(0);">{{ __('backend.Send a notification message to all users') }}</a>
                                </li>
                            ...
                            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                ...
                                <div class="widget-content widget-content-area br-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 class="table-header">
                                                {{ __('backend.Send a notification message to all users') }}</h4>
                                    ...
                                    <div class="widget-footer text-right mt-2">
                                        <button type="submit" data-url="/Send-message/Send-all" data-type="all"
