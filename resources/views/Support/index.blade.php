                                        ...
                                        <div class="widget-content widget-content-area text-center">
                                            <div class="button-list">
                                                <a href="{{ route('Support') }}">
                                                    <button type="button"
                                                        class="btn btn-outline-primary btn-rounded">{{ __('backend.All tickets') }}</button>
                                                </a>
                                                <a href="{{ route('Support', ['active']) }}">
                                                    <button type="button"
                                                        class="btn btn-outline-success btn-rounded">{{ __('backend.Active tickets') }}</button>
                                                </a>
                                                <a href="{{ route('Support', ['closed']) }}">
                                                    <button type="button"
                                                        class="btn btn-outline-dark btn-rounded">{{ __('backend.Closed tickets') }}</button>
                                                </a>
                                        ...
                                        <table id="last-page-dt" class="table table-hover" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ __('backend.ticket holder') }}</th>
                                            ...
                                            <tbody>
                                                @foreach ($reports as $report)
                                                    <tr>
                                                        <td>{{ $report->id }}</td>
                                                        <td>{{  get_user_by_id($report->user_id)->name }}</td>
                                                        <td>{{  $report->title }}</td>
                                                        <td>{{ $report->type }}</td>
                                                            ...
                                                            <div class="dropdown custom-dropdown">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <a class="dropdown-item "
                                                                        href="{{ route('Support.show', [$report->id]) }}">{{ __('backend.Show') }}</a>
