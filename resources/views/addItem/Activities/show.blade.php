            ...
            <div class="statbox widget box box-shadow mb-4">
                ...
                <div class="widget-content widget-content-area ">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" disabled="disabled" value="{{ $activitie->id }}">
                    </div>
                    <div class="form-group">
                        <label>{{ __('backend.name of activities') }}</label>
                        <input type="email" class="form-control" disabled="disabled" value="{{ $activitie->activity }}">
                    </div>

                    <div class="form-group">
                        <label>{{ __('backend.user type') }}</label>
                        <input type="email" class="form-control" disabled="disabled"
                            value="{{ $activitie->userType->name }}">
                    </div>
