...
$mapUrl = GoogleMapHelper::getMapUrl();
?>
...
<script src="{{ URL::asset('assets/frontend/js/App.js') }}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/1.3.8/FileSaver.js"></script>
{{-- EDIT AD PAGE GOOGLE MAP SCRIPT --}}
@if (Route::currentRouteName() == "user.editAdPage" || Route::currentRouteName() == 'user.officeRegistration')
    <script src="{{ URL::asset('assets/frontend/js/EditAdGoogleMap.js') }}"></script>  
    <script src= '{{ $mapUrl }}&callback=initMap&libraries=&v=weekly&libraries=places' async></script>  
@endif
@if (Route::currentRouteName() == "userProfile" || 
        Route::currentRouteName() == 'user.userInfo' ||
        Route::currentRouteName() == 'user.adPage'
        )
    <script src="{{ URL::asset('assets/frontend/js/FixedGoogleMap.js') }}"></script>  
    <script src= '{{ $mapUrl }}&callback=initMap&libraries=&v=weekly&libraries=places' async></script>  
@endif
...
<script src="{{ URL::asset('assets/frontend/js/jquerySlider/dist/jquery.flipster.min.js') }}"></script>
-->
