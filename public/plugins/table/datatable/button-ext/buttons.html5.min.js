            ...
            text: function (a) { return a.i18n("buttons.pdf", "PDF") }, action: function (a, b, d, c) {
                this.processing(!0); a = b.buttons.exportData(c.exportOptions); b = b.buttons.exportInfo(c); d = []; c.header && d.push(e.map(a.header, function (a) {
                    if (document.documentElement.lang == "ar") {
                        return {
                            text: "string" == typeof a ? a.split(' ').reverse().join(' ') : a.split(' ').reverse().join(' ') + "",
                            style: "tableHeader"
                        }
                    }
                    else {
                ...
                })); for (var f = 0, h = a.body.length; f < h; f++)d.push(e.map(a.body[f], function (a) { if (document.documentElement.lang == "ar") {
