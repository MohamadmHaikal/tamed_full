			...
			var statusBar = $("<div/>", {	id : "statusbar",
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").html('<div class="label" style="color: #8dbf42;">'+'Words : '+wordCount+'</div>');
					$(editor_Content).data("statusBar").append('<div class="label" style="color: #8dbf42;">'+'Characters : '+charCount+'</div>');
            	});
	        }	        
